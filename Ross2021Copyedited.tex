...
\addtocontentsline{toc}{section}{Rewilding Cognition}
\section{Rewilding Cognition}


\addtocontentsline{toc}{section}{Complex Dynamics in Open Experimental Systems}
...
\addtocontentsline{toc}{section}{Keywords }
\section{Keywords }

Interactivity, Insight, Thought Experiments, Exaptative Actions, Mixed Methods 
\addtocontentsline{toc}{section}{Take Home Message }
...
\addtocontentsline{toc}{section}{Abstract}
\section{Abstract}
...
\addtocontentsline{toc}{section}{Purpose }
\section{Purpose }
...
\addtocontentsline{toc}chapter{Rewilding Cognition: Complex Dynamics in Open Experimental Systems}
\chapter{Rewilding Cognition: Complex Dynamics in Open Experimental Systems}


\addtocontentsline{toc}{subsection}{The Socks Problem}
...
\addtocontentsline{toc}{subsection}{Procedure}
...
The Experimental Setup \includegraphics[width=4.92014in,height=1.96042in]{media/image1.png} 
...
\addtocontentsline{toc}{section}{Results}
\section{Results}
...
\addtocontentsline{toc}{paragraph}{}
\subparagraph{}


\addtocontentsline{toc}{paragraph}{Figure 2}
...
\addtocontentsline{toc}chapter{Qualitative Section}
...
\addtocontentsline{toc}{subsection}{Analytical Process}
...
\addtocontentsline{toc}{subsection}{Information in the Environment}
...
\textbf{Figure 3} 
The First Minute of Participant 36 Considering the Problem \includegraphics[width=5.28681in,height=3.08056in]{media/image3.png} 
...
\addtocontentsline{toc}{subsection}{Note: Stills were taken at 60 seconds and every 10 seconds thereafter.}
\subsection{Note: Stills were taken at 60 seconds and every 10 seconds thereafter.}


\addtocontentsline{toc}{subsection}{}
\subsection{}


\addtocontentsline{toc}{subsection}{Porous Cognitive Boundaries}
\subsection{Porous Cognitive Boundaries}
...
Table 1 Participant 41 Solving the Problem \begin{longtable}[]{@{} >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.14}} >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.14}} >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.44}} >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.27}}@{}} \toprule \begin{minipage}[b]{\linewidth}\raggedright \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright \textbf{04:53} \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright Pulls out two more - this time both black \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright \includegraphics[width=1.3in,height=1.7in]{media/image5.png} \end{minipage} \\ \midrule \endhead & \textbf{05:07} & "This is 8....." & \includegraphics[width=1.3in,height=1.7in]{media/image6.png} \\ & \textbf{05:08} & Looks at researcher & \includegraphics[width=1.30694in,height=1.76042in]{media/image7.png} \\ & \textbf{05:14} & Pulls through socks in hands & \includegraphics[width=1.3in,height=1.78681in]{media/image8.png} \\ & \textbf{05:21} & "So I have to pull out a pair?" & \includegraphics[width=1.37986in,height=1.7in]{media/image9.png} \\ & \textbf{05:23} & Researcher repeats instructions & \\ & \textbf{05:35} & "So I could pull out four socks and then two would be a pair" & \includegraphics[width=1.37986in,height=1.7in]{media/image10.png} \\ & \textbf{05:42} & Researcher repeats request for the \emph{minimum number} & \includegraphics[width=1.4in,height=1.82708in]{media/image11.png} \\ & \textbf{05:45} & Plays with socks in her hand & \includegraphics[width=1.4in,height=1.82708in]{media/image12.png} \\ & \textbf{05:50} & "Three" & \includegraphics[width=1.41319in,height=1.88681in]{media/image13.png} \\ & \textbf{05:57} & Correct explanation & \\ \bottomrule \end{longtable} 
...
\textbf{Table 2} 
Participant 26 Solving The Problem Through Incremental Guessing \begin{longtable}[]{@{} >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.14}} >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.14}} >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.44}} >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.27}}@{}} \toprule \begin{minipage}[b]{\linewidth}\raggedright \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright \textbf{01:18} \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright "Oh what and if I get it right you'll tell me?" \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright \includegraphics[width=1.32014in,height=1.54028in]{media/image14.png} \end{minipage} \\ \midrule \endhead & \textbf{01:21} & "Hang on, I don't know how many socks are in the bag?" & \includegraphics[width=1.32014in,height=1.51319in]{media/image15.png} \\ & \textbf{01:24} & Looks at researcher expectantly. & \includegraphics[width=1.32014in,height=1.51319in]{media/image16.png} \\ & \textbf{01:27} & "So I don't get how the ratio would matter if I don't know how many socks were in the bag....oh. it's just chance isn't it?" & \includegraphics[width=1.32014in,height=1.51319in]{media/image17.png} \\ & \textbf{01:36} & "Well, looking at the bag actually all the black ones are on top so it might be a while to get a pair of brown ones.." & \includegraphics[width=1.33333in,height=1.54653in]{media/image18.png} \\ & \textbf{01:45} & "I'm so confused by the question" Looks at researcher again & \includegraphics[width=1.32708in,height=1.51319in]{media/image19.png} \\ & \textbf{01:47} & Researcher repeats instructions & \\ & \textbf{01:50} & Starts to pull socks; Researcher stops her & \includegraphics[width=1.32708in,height=1.51319in]{media/image20.png} \\ & \textbf{02:03} & Researcher ends instructions & \\ & \textbf{02:11} & "I'd have to pick 10 socks out" & \includegraphics[width=1.28681in,height=1.54653in]{media/image21.png} \\ & \textbf{02:17} & "I'd have to pick 8 socks outs" & \includegraphics[width=1.38681in,height=1.44028in]{media/image22.png} \\ & \textbf{02:23} & "I'd have to pick 20 socks out" & \includegraphics[width=1.38681in,height=1.44028in]{media/image23.png} \\ & \textbf{02:32} & "I'd have to pick 18 socks out" & \includegraphics[width=1.37986in,height=1.44028in]{media/image24.png} \\ & \textbf{02:41} & "I'd have to pick 4 socks out". Said faster and more determined & \includegraphics[width=1.37361in,height=1.46042in]{media/image25.png} \\ & \textbf{02:44} & "2 socks" & \includegraphics[width=1.37986in,height=1.49375in]{media/image26.png} \\ & \textbf{02:47} & "3 socks" & \includegraphics[width=1.37986in,height=1.44028in]{media/image27.png} \\ & \textbf{02:49} & Researcher confirms & \\ & \textbf{02:50} & Starts to laugh & \\ & \textbf{02:51} & "When I got to the end I did...when I said 2 and then I realized...." & \includegraphics[width=1.37986in,height=1.37986in]{media/image28.png} \\ \bottomrule \end{longtable} 

\addtocontentsline{toc}{section}{}
\section{}


\addtocontentsline{toc}{section}{Discussion}
\section{Discussion}
...
\addtocontentsline{toc}{subsection}{Wide Cognition Is Contingent}
...
\addtocontentsline{toc}{subsection}{Conclusion}
...
https://doi.org/10.1002/jocb.409Vallée‐Tourangeau, F., \& Vallée-Tourangeau, G. (2014). Diagrams, jars, and matchsticks: A systemicist's toolkit. \emph{Pragmatics \& Cognition}, \emph{22}(2), 187--205. https://doi.org/10.1075/pc.22.2.02valVallée-Tourangeau, F., \& Vallée-Tourangeau, G. (2020). Mapping systemic resources in problem solving. \emph{New Ideas in Psychology, 59}.
...
(2009). How to situate cognition. In P. Robbins \& M. Ayede (Eds.), \emph{The Cambridge handbook of situated cognition} (pp. 55--78).
