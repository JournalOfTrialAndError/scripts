...
\addbibresource{Ross2021Copyedited.bib}
        ...
        % r  : reflection
          % mr : meta - research
            % rga: rejected grant application
              % ed : editorial
  \paperdoi{10.36850/TOBEFILLEDIN}
...
\addcontentsline{toc}{subsection}{Rewilding Cognition}
\subsection{Rewilding Cognition}


\addcontentsline{toc}{subsection}{Complex Dynamics in Open Experimental Systems}
...
\addcontentsline{toc}{subsection}{Take Home Message }
...
\addcontentsline{toc}{subsubsection}{The Socks Problem}
...
\addcontentsline{toc}{subsubsection}{The Current Study}
...
\addcontentsline{toc}{subparagraph}{Figure 2}
...
\addcontentsline{toc}{section}{Figure 3}
\section{Figure 3}
...
\addcontentsline{toc}{subsubsection}{Note: Stills were taken at 60 seconds and every 10 seconds thereafter.}
...
Table 1 Participant 41 Solving the Problem \begin{longtable}[]{@{} >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.14}} >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.14}} >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.44}} >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.27}}@{}} \toprule \begin{minipage}[b]{\linewidth}\raggedright \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright \textbf{04:53} \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright Pulls out two more - this time both black \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright \includegraphics[width=1.3in,height=1.7in]{media/media/image5.png} \end{minipage} \\ \midrule \endhead & \textbf{05:07} & "This is 8....." & \includegraphics[width=1.3in,height=1.7in]{media/media/image6.png} \\ & \textbf{05:08} & Looks at researcher & \includegraphics[width=1.30694in,height=1.76042in]{media/media/image7.png} \\ & \textbf{05:14} & Pulls through socks in hands & \includegraphics[width=1.3in,height=1.78681in]{media/media/image8.png} \\ & \textbf{05:21} & "So I have to pull out a pair?" & \includegraphics[width=1.37986in,height=1.7in]{media/media/image9.png} \\ & \textbf{05:23} & Researcher repeats instructions & \\ & \textbf{05:35} & "So I could pull out four socks and then two would be a pair" & \includegraphics[width=1.37986in,height=1.7in]{media/media/image10.png} \\ & \textbf{05:42} & Researcher repeats request for the \emph{minimum number} & \includegraphics[width=1.4in,height=1.82708in]{media/media/image11.png} \\ & \textbf{05:45} & Plays with socks in her hand & \includegraphics[width=1.4in,height=1.82708in]{media/media/image12.png} \\ & \textbf{05:50} & "Three" & \includegraphics[width=1.41319in,height=1.88681in]{media/media/image13.png} \\ & \textbf{05:57} & Correct explanation & \\ \bottomrule \end{longtable} 
